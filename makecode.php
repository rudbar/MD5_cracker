// этот файл преобразует в md5 только 2 сточно прописанные буквы латинского алфавита
<?php
$error = false;
$md5 = false;
$code = "";
if ( isset($_GET['code']) ) {
    $code = $_GET['code'];
    if ( strlen($code) != 4 ) {
        $error = "You should type in 4 digit numbers!";
    } else {
        $md5 = hash('md5', $code);
    }
}
...
?>
<p>Please enter a 4 digit numbers for encoding.</p>
<form>
